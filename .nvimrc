...
--     ['<leader>ss'] = { name = '[S]ymbols', _ = '<cmd>Telescope workspace_symbols<cr>' }
--     ['<leader>st'] = { name = '[T]elescope', _ = '<cmd>Telescope workspace_symbols<cr>' }
--   }
  end,
},
...
vim.keymap.set('n', '<leader>ss', '<cmd>:Telescope lsp_workspace_symbols<cr>', { desc = '[S]ymbols'})
vim.keymap.set('n', '<leader>st', '<cmd>:Telescope builtin<cr>', { desc = '[T]elescope'})

vim.keymap.set('n', '>', ":cn<cr>");
vim.keymap.set('n', '<', ":cp<cr>");

vim.keymap.set('n', '<leader>bn', '<cmd>:BookmarksMark<cr>', { desc = '[B]ookmark [N]ew' });
vim.keymap.set('n', '<leader>bj', '<cmd>:BookmarksGotoNext<cr>');
vim.keymap.set('n', '<leader>bk', '<cmd>:BookmarksGotoPrev<cr>');
vim.keymap.set('n', '<leader>bb', '<cmd>:BookmarksTree<cr>');
vim.keymap.set('n', '<leader>bd', '<cmd>:BookmarksTree<cr>');
